	subroutine enerloss_new(length,dens,zeff,aeff,epart,mpart,typeflag,Eloss)

	implicit none

	real*8 thick,length,dens,zeff,aeff,epart,mpart,Eloss
	...
	integer typeflag          !1=normal eloss (picked from distribution)
        ...
        integer numerr
	namelist /eloss_nml/length,dens,zeff,aeff,epart,mpart,typeflag,Eloss
