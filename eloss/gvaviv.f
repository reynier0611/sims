*
* $Id: gvaviv.F,v 1.1.1.1 1995/10/24 10:21:35 cernlib Exp $
*
* $Log: gvaviv.F,v $
...
*-- Author :
      subroutine gvaviv(GVAVI,RKAPPA,BETA2,RAN)
C.
C.    ******************************************************************
C.    *                                                                *
C.    *                                                                *
...
C.
   ...
   22 S0=S-FL-FU
      GVAVI=RLAM-AC(9)
      IF(S .GT. S0) GVAVI=GVAVI+AC(9)*(T-S0)/(S-S0)
c      write(6,*) 'GVAVIin', GVAVI  
      result=GVAVI
      RETURN
      END
