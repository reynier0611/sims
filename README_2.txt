...
***************************
We (Florian primarily) put back the collimator flag such that
we can easily specify the different collimator options in the
input file.

Furthermore, Barack implemented a new flag that allows for all
events (whether they hit the spectrometers or not) to be recorded
in the output tree. We are working on getting this implemented.
